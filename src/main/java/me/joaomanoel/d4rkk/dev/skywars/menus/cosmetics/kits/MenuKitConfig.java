...
public class MenuKitConfig<T extends Kit> extends PlayerMenu {
  ...
  public MenuKitConfig(Profile profile, String name, T cosmetic) {
    ...
    this.config = profile.getAbstractContainer("aCoreSkyWars", "kitconfig", KitConfigContainer.class).getOrLoadConfig(cosmetic);
  ...
  private void save(Profile profile) {
    profile.getAbstractContainer("aCoreSkyWars", "kitconfig", KitConfigContainer.class).saveConfig(this.cosmetic, this.config);
  }
