package me.joaomanoel.d4rkk.dev.skywars.menus.cosmetics.perks;
...
import me.joaomanoel.d4rkk.dev.skywars.menus.cosmetics.perks.level.MenuBuyPerkLevel;
...
public class MenuPerkUpgrade<T extends Perk> extends PlayerMenu {
  ...
  public MenuPerkUpgrade(Profile profile, String name, T cosmetic, Class<T> cosmeticClass) {
    super(profile.getPlayer(), "Perk " + cosmetic.getName(), 5);
    this.name = name;
    ...
    this.setItem(40, BukkitUtils.deserializeItemStack("INK_SACK:1 : 1 : name>&cGo Back : desc>&7To Perks " + this.name + "."));
    this.setItem(41, BukkitUtils.deserializeItemStack("INK_SACK:" +
        (!cosmetic.isSelectedPerk(profile) ? "8" : "10") + " : 1 : name>" + (cosmetic.isSelectedPerk(profile) ?
