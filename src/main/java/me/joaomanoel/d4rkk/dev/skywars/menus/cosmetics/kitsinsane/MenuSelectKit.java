...
public class MenuSelectKit<T extends KitInsane> extends PagedPlayerMenu {
          ...
          if (item != null && item.getType() != Material.AIR) {
            if (evt.getSlot() == this.previousPage) {
              ...
              if (cosmetic != null) {
                ...
                new me.joaomanoel.d4rkk.dev.skywars.menus.cosmetics.kitsinsane.MenuSelectKit<>(profile, this.cosmeticClass);
              }
            }
          }
        }
