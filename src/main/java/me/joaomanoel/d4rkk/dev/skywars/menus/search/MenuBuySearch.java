...
public class MenuBuySearch<T extends Cosmetic> extends PlayerMenu {

    private String name;
    private T cosmetic;
    public MenuBuySearch(Profile profile, String name, T cosmetic) {
        super(profile.getPlayer(), "Confirm", 3);
        this.name = name;
        this.cosmetic = cosmetic;

        this.setItem(11, BukkitUtils.deserializeItemStack(
                "159:13 : 1 : name>&aConfirm : desc>&7Unlock \"" + cosmetic.getName() + "\"\n&7Cost: &2" + StringUtils.formatNumber(cosmetic.getCoins()) + " Tokens&7."));
